 ...
 * @details Initializes the ROS2 node, publisher, TF broadcaster, service, and timer
 *          Sets up message templates and initializes counters
 */
MinimalPublisher::MinimalPublisher()
  ...
  service_ = this->create_service<std_srvs::srv::Trigger>(
      "change_message",
      std::bind(&MinimalPublisher::message_change_callback,
                this,
                std::placeholders::_1,
                std::placeholders::_2));
...
/**
 * @brief Timer callback function for periodic publishing and transform broadcasting
 * @details Publishes messages based on templates and broadcasts time-varying transforms
 *          Creates oscillating motion in translation and rotation
 */
